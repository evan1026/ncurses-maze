...
"\n"
"Usage:\n"
"    mazegame <width> <height> [--difficulty=<num>]\n"
"    mazegame --help\n"
"    mazegame --version\n"
"\n"
"Options:\n"
...
"    --difficulty=<num>, -d <num>    Difficulty [0-10] - lower values will be more of a straight line from one corner to the other. Default is 5.\n"
"\n"
"";
...
int elems_to_args(Elements *elements, DocoptArgs *args, bool help,
    ...
    for (i=0; i < elements->n_options; i++) {
        ...
        } else if (!strcmp(option->olong, "--difficulty")) {
            if (option->argument)
                args->difficulty = option->argument;
        }
    }
    /* commands */
    ...
    for (i=0; i < elements->n_arguments; i++) {
        ...
        if (!strcmp(argument->name, "<height>")) {
            args->height = argument->value;
        } else if (!strcmp(argument->name, "<width>")) {
            args->width = argument->value;
        }
    }
    return 0;
}
...
DocoptArgs docopt(int argc, char *argv[], bool help, const char *version) {
    ...
    Option options[] = {
        {"-h", "--help", 0, 0, NULL},
        {"-v", "--version", 0, 0, NULL},
        {"-d", "--difficulty", 1, 0, NULL}
    };
    Elements elements = {0, 2, 3, commands, arguments, options};
